 ...
 */
public class AvatarItemAdapterNot extends RecyclerView.Adapter<AvatarItemAdapterNot.AvatarViewHolder> {

    private static List<AvatarItemInfoNot> friendList;
    ...
    public AvatarItemAdapterNot(List<AvatarItemInfoNot> friendList, Context context) {
        this.friendList = friendList;
        this.context = context;
    }

    public AvatarItemAdapterNot(List<AvatarItemInfoNot> friendList, Context context, int size) {
        this.friendList = friendList;
        this.context = context;
        this.size = size;
    }
    ...
    public void onBindViewHolder(AvatarViewHolder friendViewHolder, int i) {
        if (i + 1 == getItemCount()) {
            ...
            AvatarItemInfoNot ci = friendList.get(i);
...
class AvatarItemInfoNot {
    protected String profileID;

    AvatarItemInfoNot(String profileID) {
